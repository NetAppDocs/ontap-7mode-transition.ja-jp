...
summary: Sun Volume Manager を搭載した Solaris ホストデータ LUN を ONTAP 7-Mode から clustered ONTAP に移行する前に、移行プロセスに必要な情報を収集する必要があります。 
---
...
----
. SVM を表示して記録し、 SVM に関連付けられているディスクを取得します。
+
「 * metaset * 」
